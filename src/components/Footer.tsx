...
const Footer = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between px-5 mt-10 bg-secondary border border-accent">
      ...
      <hr className="border-primary md:mx-0 mx-auto my-3 border w-80 mt-2 flex md:float-right" />
      ...
      <div className="text-center bg-primary w-full">
        <p className="flex items-center justify-center">© 2024 - NUSA Creazioni</p>
      </div>
    </div>
  );
};
